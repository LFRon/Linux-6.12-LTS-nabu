...
#define TSK_ACTIVE_MM 1104 /* offsetof(struct task_struct, active_mm) */
...
#define TSK_STACK_CANARY 1232 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2720 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 4368 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 4264 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 4344 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 4360 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define MM_CONTEXT_ID 952 /* offsetof(struct mm_struct, context.id.counter) */
...
#define VCPU_FAULT_DISR 3416 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_HCR_EL2 3368 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
#define CPU_USER_PT_REGS 0 /* offsetof(struct kvm_cpu_context, regs) */
#define CPU_ELR_EL2 1728 /* offsetof(struct kvm_cpu_context, sys_regs[ELR_EL2]) */
...
#define HOST_CONTEXT_VCPU 3088 /* offsetof(struct kvm_cpu_context, __hyp_running_vcpu) */
...
#define TRAMP_VALIAS -10534912 /* TRAMP_VALIAS */
